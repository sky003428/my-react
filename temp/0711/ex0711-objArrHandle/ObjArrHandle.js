...
function ObjArrHandle() {
    ...
    return (
        <>
            ...
            <button
                onClick={() => {
                    const newObj = data.filter((v) => {
                        return v.text.indexOf('b') === -1;
                    });
            ...
            <button
                onClick={() => {
                    ...
                    const newData = [{ id: newId, text: 'xxx' }, ...data];
            ...
            <button
                onClick={() => {
                    ...
                    const newData = [...data, { id: newId, text: 'yyy' }];
